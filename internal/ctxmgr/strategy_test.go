...
func TestAnchorStrategy_BasicMessages(t *testing.T) {
	entries := []tape.TapeEntry{
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "user", "content": "hello"})},
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "assistant", "content": "hi"})},
	}
...
func TestAnchorStrategy_RespectsAnchors(t *testing.T) {
	entries := []tape.TapeEntry{
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "user", "content": "old"})},
		{Kind: tape.KindAnchor, Payload: tape.MarshalPayload(map[string]any{"label": "reset"})},
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "user", "content": "new"})},
	}
...
func TestAnchorStrategy_TrimToFit(t *testing.T) {
	...
	entries := []tape.TapeEntry{
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "user", "content": strings.Repeat("a", 400)})},
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "assistant", "content": strings.Repeat("b", 400)})},
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "user", "content": "last"})},
	}
...
func TestMaskingStrategy_NoMaskingUnderThreshold(t *testing.T) {
	...
	entries := []tape.TapeEntry{
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "user", "content": "run tool"})},
		{Kind: tape.KindMessage, Payload: tape.MarshalPayload(map[string]any{"role": "tool", "content": longOutput, "tool_call_id": "t1"})},
	}
